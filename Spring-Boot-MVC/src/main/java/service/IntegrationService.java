...
import dto.Product;
import dto.ProductResponseInfo;
...
public class IntegrationService {
	...
	private static final String URL = "http://localhost:8075";
	...
	public List<Product> getProductList() {
		...
		headers.add("Authorization", "Basic YWRtaW46YWRtaW4xMjM=");
	...
	public Product getProductById(String id) {
		...
		ResponseEntity<ProductResponseInfo> response = restTemplate.exchange(URL + "/product/" + id, HttpMethod.GET,
				entity, ProductResponseInfo.class);
